...
public class SpellWritingTableContainerScreen extends ContainerScreen<SpellWritingTableContainer> {
    ...
    public SpellWritingTableContainerScreen(SpellWritingTableContainer container, PlayerInventory inventory, ITextComponent title) {
